...
1. [Python JSON – Read a JSON file](https://howtodoinjava.com/python/json/python-read-json-file/)
2. [Python JSON – Read a JSON String](https://howtodoinjava.com/python/json/python-read-json-string/)
